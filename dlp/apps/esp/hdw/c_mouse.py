...
from apps.esp.hdw.hdw_common import MouseInput as MouseInput

class CMouse(ctypes.Structure):
    ...
    def _do_event(self, flags, x_pos, y_pos, data, extra_info):
        ...
        print('x={0}'.format(ctypes.windll.user32.GetSystemMetrics(self.SM_CXSCREEN)))
        ...
        print('({0}, {1}) is clicked'.format(x_calc, y_calc))
    ...
    def click(self, pos=(-1, -1), button_name= "left"):
        ...
        self.move_mouse(pos)
        self._do_event(self._get_button_value(button_name, False)+self._get_button_value(button_name, True), pos[0], pos[1], 0, 0)
